...
public:
	...
	inline static	int			screenHeight = 675;
	inline static	glm::vec4	clearColor = { 0.2f, 0.6f, 0.6f, 1.0f };
	...
	inline static	float		textEdge = 0.08f;
	inline static	glm::vec3	textColor = { 0.0f, 0.0f, 0.0f };
	inline static	int			maxQuads = 1000;
};